...
class Member extends Base
{
    ...
    public function login(Request $request)
    {
        ...
        if($memberInfo)
        {
            ...
            {
                $field= 'a.store_id,a.store_name,IFNULL(a.store_avatar,"") as store_avatar,a.area_info,a.store_address,IFNULL(a.store_workingtime,"") as store_workingtime,a.store_state,a.store_description,IFNULL(b.business_licence_number_electronic,"") as business_licence_number_electronic,c.member_id,IFNULL(c.member_mobile,"") as member_mobile';
