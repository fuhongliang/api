...
class Member extends Base
{
    ...
    public function login(Request $request)
    {
        ...
        if($memberInfo)
        {
            ...
            {
                $field= 'a.store_id,a.store_name,IFNULL(a.store_avatar,"") as store_avatar,a.area_info,a.store_address,a.store_workingtime,a.store_phone
                ,a.store_state,a.store_description,b.business_licence_number_electronic,c.member_id,c.member_mobile';
