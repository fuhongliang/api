<?php
    ...
    class Member extends BModel
    {
        ...
        {
            return DB::table('voucher_template')->where('voucher_t_store_id', $store_id)->where('voucher_t_start_date', '<', time())->where('voucher_t_end_date', '>', time())->where('voucher_t_state', 1)->sum('voucher_t_price');
        }
